...
import { PerformanceVisualizations } from './PerformanceVisualizations.tsx';

const meta: Meta<typeof PerformanceVisualizations> = {
  title: 'Dev/PerformanceVisualizations',
  component: PerformanceVisualizations,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
export default meta;
type Story = StoryObj<typeof PerformanceVisualizations>;
