...
export default function CategoryGoals({
  ...
  const _handleAddGoal = () => {
    ...
    onAddGoal({
      ...
      target: 100,
      current: _latestScore.categoryScores[selectedCategory],
    ...
    >
      <Card className="p-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-3">
          {_WELLNESS_CATEGORIES.map(category => (
            <Button
              key={category}
              ...
              >
                ...
                <Progress
                  ...
                  style={
                    {
                      backgroundColor: `${
                        _CATEGORY_COLORS[selectedCategory as keyof typeof _CATEGORY_COLORS]
                      }20`,
                      '--progress-foreground':
                        _CATEGORY_COLORS[selectedCategory as keyof typeof _CATEGORY_COLORS],
                    } as any
